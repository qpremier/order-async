import { aggregateStatuses, ImportRequestError, } from "./import-domain.server.js";
export async function applySkuMapping(prisma, input) {
    return prisma.$transaction(async (tx) => {
        ...
        for (const orderIntentId of affectedIntentIds) {
            ...
            const status = statusFromValidation(remainingLines.map((line) => line.validationStatus));
