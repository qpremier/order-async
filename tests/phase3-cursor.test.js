...
import { buildDescendingKeysetArgs, decodeKeysetCursor, encodeKeysetCursor, InvalidCursorError, toKeysetPage, } from "../app/services/pagination/cursor.server";
describe("Phase 3 local keyset cursors", () => {
    ...
    it("rejects malformed cursors", () => {
        ...
        expect(() => decodeKeysetCursor(Buffer.from(JSON.stringify({ v: 1, id: "missing-date" })).toString("base64url"))).toThrow(InvalidCursorError);
    });
